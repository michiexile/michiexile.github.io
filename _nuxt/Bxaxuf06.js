import L from"./C8SJr0bx.js";import{j as D,C as i,D as T,E as j,F as x,G as E,o as p,c as l,H as h,I as R,s as G,z as U,b as z,J as y}from"./Dx9fzR9l.js";import{u as N}from"./bnaovxPR.js";import"./BtlyzL4O.js";function V(s,o,a){const[e={},c]=typeof o=="string"?[{},o]:[o,a],t=D(()=>i(s)),n=e.key||T([c,typeof t.value=="string"?t.value:"",...B(e)]);if(!n||typeof n!="string")throw new TypeError("[nuxt] [useFetch] key must be a string: "+n);const f=n===c?"$f"+n:n;if(!e.baseURL&&typeof t.value=="string"&&t.value[0]==="/"&&t.value[1]==="/")throw new Error('[nuxt] [useFetch] the request URL must not start with "//".');const{server:d,lazy:g,default:m,transform:u,pick:v,watch:_,immediate:$,getCachedData:O,deep:q,dedupe:A,...C}=e,b=j({...x,...C,cache:typeof e.cache=="boolean"?void 0:e.cache}),F={server:d,lazy:g,default:m,transform:u,pick:v,immediate:$,getCachedData:O,deep:q,dedupe:A,watch:_===!1?[]:[b,t,..._||[]]};let r;return N(f,()=>{var k;(k=r==null?void 0:r.abort)==null||k.call(r),r=typeof AbortController<"u"?new AbortController:{};const w=i(e.timeout);return w&&setTimeout(()=>r.abort(),w),(e.$fetch||globalThis.$fetch)(t.value,{signal:r.signal,...b})},F)}function B(s){var a;const o=[((a=i(s.method))==null?void 0:a.toUpperCase())||"GET",i(s.baseURL)];for(const e of[s.params||s.query]){const c=i(e);if(!c)continue;const t={};for(const[n,f]of Object.entries(c))t[i(n)]=i(f);o.push(t)}return o}const I={key:0},P="https://api.github.com/graphql",Y={__name:"GithubPagesList",props:["owner"],async setup(s){let o,a;const e=s,t=U().githubApiToken,n=`
query {
