import q from"./LinkToGithubIo.dfb4680e.js";import{a as A,u as g,b as x,w as C,o as n,e as s,F as p,r as D,f as L,h as y}from"./entry.74707ad8.js";import{u as T}from"./asyncData.305e2e12.js";function v(i,e,a){const[t={},m]=typeof e=="string"?[{},e]:[e,a],o=t.key||m;if(!o||typeof o!="string")throw new TypeError("[nuxt] [useFetch] key must be a string: "+o);if(!i)throw new Error("[nuxt] [useFetch] request is missing.");const l="$f"+o,c=A(()=>{let u=i;return typeof u=="function"&&(u=u()),g(u)}),{server:f,lazy:_,default:d,transform:h,pick:r,watch:w,initialCache:k,immediate:b,...F}=t,O={...F,cache:typeof t.cache=="boolean"?void 0:t.cache},$={server:f,lazy:_,default:d,transform:h,pick:r,initialCache:k,immediate:b,watch:[c,...w||[]]};return T(l,()=>$fetch(c.value,O),$)}const E={key:0},P={__name:"GithubPagesList",props:["owner"],async setup(i){let e,a;const t=i,o=x().githubApiToken,l="https://api.github.com/graphql",c=`
query {
